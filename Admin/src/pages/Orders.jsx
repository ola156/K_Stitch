    ...
    <div>
      ...
      <div>
        {orders.map((order, index) => (
          <div
            key={index}
            className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr] gap-4 items-start border  border-gray-400 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-sm text-gray-800"
          >
            ...
            <p className="text-xl  sm:text-[20px]">
