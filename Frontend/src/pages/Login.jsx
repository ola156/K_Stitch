  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between text-sm mt-[-8px]">
        <p className="cursor-pointer text-center ml-5">
          Forgot your password ?
        </p>
        {currentState === "Login" ? (
          <p
            onClick={() => setCurrentState("Sign Up")}
            className="cursor-pointer mr-6 text-blue-500"
          >
            Creat Account
          </p>
        ) : (
      ...
      <button className="bg-gray-300 text-black rounded font-light px-8 py-2 mt-4">
